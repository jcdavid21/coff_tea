...
<body>
    ...
    <main>
        <div class="flex items-center justify-center pt-12">
            <div class="container">
                <h2 class="text-4xl pb-2 border-b border-b-slate-700">Manage Orders</h2>
    ...
    <div id="static-modal" class="hidden fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center">
        <div class="relative w-full max-w-lg p-4 bg-white rounded-lg shadow dark:bg-white">
            ...
            <div class="flex justify-between items-center p-4 border-b dark:border-gray-600">
                <h3 class="text-lg font-semibold text-black">Order Details</h3>
            ...
            <form action="" class="mt-6 mb-6 grid grid-cols-3 gap-4">
                ...
                <div class="col-span-3">
                    <label for="quantity" class="block text-sm font-medium text-gray-700">Date Ordered</label>
                    <input type="text" name="quantity" id="quantity" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="October 12, 2024" disabled>
                </div>
                <div>
                    <div class="mb-2 font-medium">Add-ons</div>
                ...
                <div class="col-span-3">
                    ...
                    <input type="number" name="quantity" id="quantity" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="2" min="1" disabled>
                </div>
            </form>

            <!-- Modal Footer -->
            <div class="flex justify-end space-x-2 p-4 border-t dark:border-gray-600">
                <button class="close-modal-footer px-5 py-2 text-white bg-gray-700 border rounded-lg hover:bg-gray-800">Close</button>
            </div>
        </div>
    </div>
